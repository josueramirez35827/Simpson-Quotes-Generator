...
# MVP - Features
* Search bar to that takes in user input
* Cards showing the results of said search that can be selected
* Expanded card displaying specific information on selected card
